<footer>
    <div class="mt-20 bg-gray-800 pt-9">
        <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
            <div class="flex w-full justify-between items-center px-10 mb-5">
                <div class="bg-gray-600 p-5 text-white rounded-md"> <span class="p-3 rounded-full bg-blue-600"><i class="text-2xl fa-solid fa-square-check"></i></span> Chất lượng được kiểm duyệt</div>
                <div class="bg-gray-600 p-5 text-white rounded-md"> <span class="p-3 rounded-full bg-green-400"><i class="text-2xl fa-solid fa-truck-fast"></i></span> Miễn phí vận chuyển</div>
                <div class="bg-gray-600 p-5 text-white rounded-md"> <span class="p-3 rounded-full bg-amber-400 text-green-500"><i class="text-2xl text-green-500 fa-solid fa-money-check-dollar"></i></span> Thanh toán nhanh gọn</div>
                <div class="bg-gray-600 p-5 text-white rounded-md"> <span class="p-3 rounded-full bg-red-500 text-blue-600"><i class="fa-solid text-2xl fa-phone-volume"></i></span> Hỗ trợ 24/7</div>
            </div>
            <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                <div class="md:w-[316px]">
                    ...
                    <h1 class="text-white font-extrabold">
                        <img class="w-2/3 rounded-lg" src="uploads/img/logo.png" alt="">
                    </h1>
                    </p>
                    <p class="mt-[18px] text-[15px] font-normal text-white/[80%]">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Eos, fugit non. Incidunt dolorum adipisci, tempore asperiores nemo odio facere officiis enim animi.</p>
                    <form class="w-full flex justify-between mt-5" action="" method="get">
                        <input class="w-full p-2.5 rounded-l-md" type="text" name="key" id="key" placeholder="Email liên hệ...">
                        <button class="w-1/6 rounded-r-md bg-amber-400 text-white" type="submit"><i class="fa-solid fa-paper-plane"></i></button>
                    </form>
                </div>
                <div class="md:w-[316px]">
                    <div class="mt-[23px] flex">
                        ...
                        <div class="ml-[18px]">
                            <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium text-white">+84 702024861</a>
                            <p class="font-Inter text-[12px] font-medium text-white">Số điện thoại hỗ trợ</p>
                        </div>
                    </div>
                    <div class="mt-[23px] flex">
                        <div class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                        ...
                        <div class="ml-[18px]">
                            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">crislamm10@gmail.com</a>
                            <p class="font-Inter text-[12px] font-medium text-[#fff]">Email hỗ trợ</p>
                        </div>
                    </div>
                    <div class="mt-[23px] flex">
                        <div class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                        ...
                        <div class="ml-[18px]">
                            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">Trịnh Văn Bô, Nam Từ Liêm, Hà Nội</a>
                            <p class="font-Inter text-[12px] font-medium text-white">Địa chỉ</p>
                        </div>
                    </div>
                </div>
                <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
                    <div class="">
                        <p class="text-deutziawhite font-inter text-[22px] font-medium leading-normal">Pages</p>
                        <ul>
                            <li class="mt-[15px]"><a class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="">Trang chủ</a></li>
                            <li class="mt-[15px]"><a class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="">Sản phẩm</a></li>
                            <li class="mt-[15px]"><a class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="">Liên hệ</a></li>
                            <li class="mt-[15px]"><a class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="">Bài viết</a></li>
                    </div>
                    <div class="mt-6 flex flex-col gap-4 sm:mt-0">
                        <p class="text-deutziawhite font-inter text-[22px] font-medium">Theo dõi chúng tôi</p>
                        <div class="flex gap-4 sm:flex-col">
                            <a href="#" class="text-white"><i class="text-2xl fa-brands fa-facebook"></i> Lê Văn Lâm</a>
                            <a href="#" class="text-white"><i class="text-2xl fa-brands fa-github"></i> LamDev10</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-center pb-8 pt-[9px] md:py-8">
                <p class="text-[10px] font-normal text-white md:text-[12px]">
                    © Copyright
                    <!-- -->2024
                    <!-- -->, All Rights Reserved by FUNITURE SHOP
                </p>
            </div>
        </div>
    </div>
